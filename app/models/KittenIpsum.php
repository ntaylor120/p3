...
class KittenIpsum
{
    ...
    public $words = array(
        // Lorem ipsum...
        'Kitten Ipsum',        'purr',       'meow',        'murf',
        'cat',         'kitten', 'paws',   'whiskers',
        // The rest of the vocabulary
        'tail',            'fluffy',          'accumsan',     'ad',
        'sleep',       'eat',     'chase the mouse',      'stalk',
        '3 am..time to play!',       'catnip',        'run',           'pounce',
        'stalk',        'stare',    'bat',      'bite',
        'nap',      'snooze', 'sunshine patch',       'skitter ball',
        'catnip mouse',      'fluffy',   'tabby',         'calico',
        'tortoiseshell',          'tortitude',   'Soft kitty, warm kitty, little ball of fur.  happy kitty, sleepy kitty, purr purr purr',        'sneak',
        'playtime',          'food',        'milk',     'cream',     
    );
