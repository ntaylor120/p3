...
class PirateIpsum
{
    ...
    public $words = array(
        // Lorem ipsum...
        'Ahoy',        'Thar',       'Matey!',        'Avast',
        'port',         'starboard', 'bow',   'stern',
        // The rest of the vocabulary
        'abaft',            'aft',          'argh',     'arr',
        'arrgh',       'avast ye',     'avast',      'aye',
        'batten down the hatches',       'binnacle',        'bilge',           'bilge pump',
        'bilge water',        'binnacle',    'black jack',      'black spot',
        'blimey',      'blow the man down', 'booty',       'bucaneer',
        'bucko',      'cacle fruit',   'careen',         'cat o\' nine tails',
        'chain shot',          'chantey',   'clap of thunder',        'coaming',
        'cockswain',      'corsair',        'crows nest',       'cutlass',
        'dance the hempen jig',    'davey jones locker',         'dead men tell no tales',        'deadlights',
        'doubloons',         'duffle',     'dungbie',         'feed the fish',
        'flibustier',    'fore',        'freebooter',         'gangway',
        'grog',          'hang the jib',          'hand',        'harr',
        'head',      'heave ho',    'heave to',    'hempen halter',
        'hornswaggle',     'jack',       'jack ketch',    'jack o\' coins',
        'jack o\' cups',    'jack o\' staves',       'jack o\' swords',      'jack tar',
        'jacobs ladder',    'jolly roger',         'keel haul',    'lad',
        'landlubber',      'lass',          'letter of marque',    'man o\' war',
        'marooned',     'mast',     'matey',     'me',
        'me hearties',      'messdeck',       'mizzenmast',      'monkey',
        'monkey jacket',          'old salt',      'on the account',       'orlop',
        'overhaul',     'pieces of eight',      'poop deck',     'port',
        'powder monkey',       'privateer',   'prow',        'rigging',
        'ropes end',       'scallywag',       'scurvy',           'scuttle',
        'seadog',       'shanty',      'shark bait',        'shivver me timbers',
        'sink me',          'six pounders',    'smartly',      'son of a biscuit eater',
        'spars',        'splice the mainbrace',       'sprogs',         'squiffy',
        'starboard',         'sutler',         'swab',       'thar she blows',
        'the hulks',       'three sheets to the wind',        'titivate',         'walk the plank',
        'weight anchor',       'yarr',  'ye', 'yo ho ho',
        'all hand hoa',          'starboard',    'jib',    'running with the wind',
        'close hauled',       'abeam',       'before the wind',    'in irons',
